      ...
      <main id="main">
        <section className="hero container">
          <div className="hero-copy">
            ...
            <h1 className="story-headline">Connect sustainability and financial performance.<br /><em>Through metrics you can act on.</em></h1>
            <p className="hero-lead">Bring your measures. Understand their meaning. Decide how to use them.</p>
            <p className="hero-description">Metric Lab helps you develop and assess integrated KPIs that connect financial and sustainability measures. Examine their assumptions and where managers may disagree before putting them to work.</p>
            <div className="hero-actions"><a href="#lab" className="button primary">Assess your metric <span aria-hidden="true">↗</span></a><a className="quiet-link" href="#approach">See how it works <span aria-hidden="true">↓</span></a></div>
          </div>
          <div className="decision-card">
            ...
            <p className="card-caption">Understand the differences. Watch the question change.</p>
          </div>
        </section>
        ...
        <section className="approach-section" id="approach"><div className="container"><div className="section-heading"><div><p className="eyebrow">From measurement to meaning</p><h2>Run the disagreement.<br /><em>Before the commitment.</em></h2></div><p>Bring an existing iKPI or separate financial and sustainability measures. Leave with a clearer understanding of what they capture, what they may conceal and how they could inform action.</p></div><div className="steps-grid">
          ...
          <article className="step-card"><span className="step-number">02</span><span className="step-icon" aria-hidden="true">⇄</span><h3>Understand the differences.</h3><p>What could the same metric mean to your CEO, sustainability manager and operational manager? Explore potential differences in interpretation, evidence and control.</p><span className="step-foot">Your output · A potential conflict map</span></article>
