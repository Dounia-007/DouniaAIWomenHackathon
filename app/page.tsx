  ...
  return (
    <>
      ...
      <main id="main">
        ...
        <section className="container prepared-section"><p className="eyebrow">Built through research and iteration</p><h2>What we built. What we learned.</h2><p>Dounia Chlyeh contributed the research framework, source material, EPS baseline and product direction. ChatGPT/Codex assisted with design, implementation, evidence paraphrasing and testing. Additional team contributions should be documented by the participants.</p><p>Feedback led us from a dense workbench to a prepared decision journey. The current prototype makes assumptions visible and links unresolved issues to an agenda. Live AI access remains unresolved; prepared scenarios are explicitly labelled and await researcher review.</p><a className="quiet-link" href="https://github.com/Dounia-007/DouniaAIWomenHackathon/blob/design/metric-lab-framework/docs/DEVELOPMENT_HISTORY.md">Read the development record ↗</a></section><section className="closing container"><p className="eyebrow">What you take away</p><h2>A clearer view of your metric.<br /><em>A better starting point for action.</em></h2><p>Understand what your metric captures, what it may conceal and what needs resolving before you use it. Your team leaves with an assessment, a potential conflict map and a focused agenda.</p><a className="button primary" href="#lab">Start the conversation <span aria-hidden="true">↗</span></a></section>
      </main>
